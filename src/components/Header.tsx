    ...
    <div className="md:max-w-[1920px] bg-black">
      <div className="flex justify-between items-center h-[90px] w-full px-8">
        ...
        <nav className="hidden md:flex space-x-6">
          <Link href="/HeroSection" className='text-lg font-bold text-[#FF9F0D]'>Home</Link>
          ...
          <Link href="/HeroSection" className='text-lg font-bold text-[#FF9F0D] block'>Home</Link>
          ...
          <Link href="/contact" className='text-lg font-bold text-black block'>Contact</Link>
        </nav>
            </SheetContent>
          </Sheet>
